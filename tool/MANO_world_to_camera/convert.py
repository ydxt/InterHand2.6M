...
import torch
import cv2
from common.utils.preprocessing import load_img, load_skeleton
...
# mano layer
smplx_path = 'D:/workspace/gen_data/smplx/models' # 'SMPLX_PATH'
...
joint_regressor = np.load('G:/Datasets/InterHand2_dot_6M/InterHand2.6M/tool/MANO_world_to_camera/J_regressor_mano_ih26m.npy')
root_joint_idx = 20
...
root_path = 'G:/Datasets/InterHand2_dot_6M/InterHand2.6M_5fps_batch1/'
...
hand_joint_num = 21 # single hand
hand_root_joint_idx = {'right': 20, 'left': 41}
hand_joint_type = {'right': np.arange(0, hand_joint_num), 'left': np.arange(hand_joint_num, hand_joint_num*2)}
hand_skeleton = load_skeleton(osp.join(annot_root_path, "skeleton.txt"), hand_joint_num*2)
...
for img_path in img_path_list:
    ...
    frame_idx = os.path.basename(img_path)[5:-4]
